...
final class TaskModelTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        testTask1 = task(name: "clean toilet", group_id: "1", user_id: "1", description: "scrub it", status: "Pending", date_started: "10/10/2021", date_completed: "10/11/2021", priority: "high")
    }
    ...
    func testInitializeTask() {
        ...
        XCTAssertEqual(testTask1.status, "Pending")
