    ...
    var body: some View {
        ZStack {
            if showPreview, let capturedImage = image {
                ...
                ImagePreviewView(image: capturedImage, isPresented: $isPresented, showPreview: $showPreview, onClaimTask: onClaimTask)
            } else {
...
//                CustomCameraInterfaceView(image: $image, showPreview: $showPreview, takePhoto: takePhoto, onClaimTask: onClaimTask)
                CustomCameraInterfaceView(image: $image, showPreview: $showPreview, takePhoto: takePhoto, onClaimTask: onClaimTask, onDismiss: {
...
struct CustomCameraInterfaceView: View {
    @Binding var image: UIImage?
    @Binding var showPreview: Bool
